...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    liked_book = models.ManyToManyField(Book, related_name='liked_book', verbose_name="Вподобані книги")
    disliked_book = models.ManyToManyField(Book, related_name='disliked_book', verbose_name="Невподобані книги")
    liked_discussion = models.ManyToManyField(Discussion, related_name='liked_discusion', verbose_name="Вподобані обговорення")
    disliked_discussion = models.ManyToManyField(Discussion, related_name='disliked_discusion', verbose_name="Невподобані обговорення")
