...
class MyUserAdmin(UserAdmin):
        model = User
        list_display = ('slug', 'username','email', 'photo', 'created_at', 'is_superuser', 'is_active','get_liked_book','get_disliked_book', 'get_liked_discussion', 'get_disliked_discussion')
