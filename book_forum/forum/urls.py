...
urlpatterns = [
    ...
    path(
        "<slug:book_slug>/discussion/<slug:discussion_slug>/answer_comment",
        answer_discussion_comment,
        name="answer_discussion_comment",
    ),
    path(
        "<slug:book_slug>/discussion/<slug:discussion_slug>/dislike",
        dislike_discussion,
        name="dislike_discussion",
    ),
    path(
        "<slug:book_slug>/discussion/<slug:discussion_slug>/like",
        like_discussion,
        name="like_discussion",
    ),
    path(
        "<slug:book_slug>/discussion/<slug:discussion_slug>/",
        discussion,
        name="discussion",
    ),
    path(
        "<slug:book_slug>/add_discussion/",
